...
import { Chofer, Direccion, Pedido, Producto, PedidoActivo } from 'src/app/interfaces/compra.interface';
...
export class HomePage implements OnInit {
  ...
  agregar(nombre) {
    this.pedido[nombre].cantidad++;
    this.cuenta = this.pedido[nombre].precio * this.pedido[nombre].cantidad;
  }

  quitar(nombre) {
    if (this.pedido[nombre].cantidad === 0) {
      this.cuenta = 0;
      return;
    } else {
      this.pedido[nombre].cantidad--;
