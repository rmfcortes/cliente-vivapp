...
export class PedidoPage implements OnInit {
  ...
  getUbicacion() {
    this.ubSub = this.compraService.getStatusPedido(this.pedido.id).subscribe(async (coords: any) => {
  ...
  terminarPedido(resp) {
    ...
    this.calPend = true;
    this.pedidoCalificado(resp);
  }

  pedidoCalificado(resp) {
